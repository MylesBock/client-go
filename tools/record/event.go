...
import (
	...
	"github.com/MylesBock/client-go/tools/record/util"
	ref "github.com/MylesBock/client-go/tools/reference"
	"k8s.io/klog"
)
...
// EventRecorderAdapter is a wrapper around a "github.com/MylesBock/client-go/tools/record".EventRecorder
// implementing the new "github.com/MylesBock/client-go/tools/events".EventRecorder interface.
type EventRecorderAdapter struct {
	recorder EventRecorder
}

// NewEventRecorderAdapter returns an adapter implementing the new
// "github.com/MylesBock/client-go/tools/events".EventRecorder interface.
